...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "Clone the develop branch of the repogit clone -b develop https://github.com/JuliaMPC/MAVsBuild imagesh build.sh"
},
...

{
    ...
    "title": "Running demos",
    "category": "section",
    "text": "The most basic usage of MAVs is simply running the demos. For instance, demoA can be run as:$roslaunch system demoA.launchNote: package demos documentation is provided in the description of the package"
},
...

{
    ...
    "category": "section",
    "text": "You can rebuild the workspace in two ways. The first method takes shorter time.Rebuild the ros workspace inside the container:  $cd ~/MAVs/ros\n$catkin_makeAfter that, you need to commit the change of image:   Open a new terminal$docker ps -l\n$docker commit <container_name> <image_name>  2. Rebuild the image if container is terminated:$sh build.sh"
},
...
{
    "location": "packages/model/gazebo/vehicle_description/main.html#Flags-and-Settings-1",
    "page": "vehicle_description",
...
{
    "location": "packages/computing/perception/obstacle_detector/main.html#Flags-and-Settings-1",
    "page": "obstacle_detector",
    "title": "Flags and Settings",
    "category": "section",
    "text": ""
...
{
    "location": "packages/model/chrono/ros_chrono/main.html#Output-2",
    "page": "ros_chrono",
    "title": "Output",
    "category": "section",
    "text": ""
...
{
    "location": "packages/model/chrono/ros_chrono/main.html#Output-3",
    "page": "ros_chrono",
    "title": "Output",
    "category": "section",
    "text": ""
...
{
    "location": "packages/model/chrono/ros_chrono/main.html#Output-4",
    "page": "ros_chrono",
    "title": "Output",
    "category": "section",
    "text": ""
...

{
    ...
    "title": "All  Modes",
    "category": "section",
    "text": "The following settings, flags, topics, and parameters apply to all modes."
},
...
{
    "location": "packages/model/chrono/ros_chrono/main.html#MODE4:-dynamic-speed-trajectory-tracking-1",
    "page": "ros_chrono",
    "title": "MODE4: dynamic speed trajectory tracking",
    "category": "section",
    "text": "[INSERT DESCRIPTION]To run:"
},
...
{
    "location": "packages/model/chrono/ros_chrono/main.html#Notes-8",
    "page": "ros_chrono",
    "title": "Notes",
    "category": "section",
    "text": ""
...
{
    "location": "packages/model/chrono/ros_chrono/main.html#Expected-Output-7",
    "page": "ros_chrono",
    "title": "Expected Output",
    "category": "section",
...
{
    "location": "packages/computing/planning/nloptcontrol_planner/main.html#MAVs.jl-1",
    "page": "nloptcontrol_planner",
    "title": "MAVs.jl",
    "category": "section",
...

{
    ...
    "category": "section",
    "text": "The workflow is consisted of two part: build and run For build part: Pull the base image from c1yxuan/avpg_base Build Dockerfile: this Dockerfile mainly copy the source files in ros/ into the container and run “catkin_make” to setup ros workspace. Inside the Dockerfile of c1yxuan/avpg_base: Pull the base image from nvidia/opengl:runtime Install essential packages Install ROS kinetic Install Julia Install Chrono For run part: Setup PATH variable for later use of volumes when execute docker run. docker run command to execute mavs image.What are Volumes? For simplicity, volumes are the mechanism for persisting data generated by and used by Docker containers. Click here for more information. In run.sh, several volumes are created. For shared_dir/ directory, this one is used to store the demonstration data and we can do some post process after we terminate the container. As for ros/src/ directory, it shares the source files in the local machine with container. It means we can modify the files outside the container and see the instant change inside the container. And this can be used at the scenario that we need to update script file, such as Python, ROS launch file, without rebuild the image."
},
...

{
    ...
    "category": "section",
    "text": "Save changes made in docker container: docker ps -l	find the container ID docker commit <container_id> [repository[:tag]]    Change the docker name tag in ./run.shUpload base image to Docker Hub: docker tag <container> [DockerUserName/Repository[:tag]] docker push [DockerUserName/Repository[:tag]]Run open up new terminals to access Container (example): Look at the current containers available with $ docker container ls CONTAINER ID        IMAGE               COMMAND                  CREATED             STATUS              PORTS               NAMES ce4096e14bef        mavs                \"/ros_entrypoint.sh …\"   34 minutes ago      Up 34 minutes                           vigilant_johnson Open terminal docker exec -it vigilant_johnson /bin/bash Note: you can use “tab” key to auto-complete the <container_name>"
},
